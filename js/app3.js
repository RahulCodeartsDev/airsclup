...
$('.btnNext').click(function(){
    $('.tab_head_back > .tab_active').next('li').trigger('click');
    if($('.tab_head_back > li').first().hasClass('tab_active')){
        setTimeout(() => {
            $('.customPrevBtn').hide();
            $('.cancleButton').show();
            $('.customBookBtn').hide();
        }, 50);
     } else if($('.tab_head_back > li').last().hasClass('tab_active')){
        setTimeout(() => {
            $('.customPrevBtn').show();
            $('.customNextBtn').hide();
            $('.cancleButton').hide();
    ...
    $('.tab_head_back > .tab_active').prev('li').trigger('click');
  });
